...
export class SBXCDI extends Construct {
    constructor(scope: Construct, id: string, props: SBXCDIProps) {
        ...
        const regionMap = new CfnMapping(this, 'RegionMap', {
            mapping: {
                'us-west-2': {'ami': 'ami-06caef45b966ee963'},
                'us-west-1': {'ami': 'ami-0abda61e1bea911ca'},
                'us-east-2': {'ami': 'ami-0bc121d92def0c8d0'},
                'us-east-1': {'ami': 'ami-019841f3bbdbdb5ed'},
                'sa-east-1': {'ami': 'ami-096a38194aebe9016'},
                'me-south-1': {'ami': 'ami-026aefc164c053e48'},
                'eu-west-3': {'ami': 'ami-0847574a5a1fd4d96'},
                'eu-west-2': {'ami': 'ami-053efb2000d7311dd'},
                'eu-west-1': {'ami': 'ami-00b24f2c1ac262051'},
                'eu-south-1': {'ami': 'ami-0396225aec95ac6a3'},
                'eu-north-1': {'ami': 'ami-0915bbefbdb12621c'},
                'eu-central-1': {'ami': 'ami-0d7d0de034a1cfc14'},
                'ca-central-1': {'ami': 'ami-0333ec80090dd316d'},
                'ap-southeast-3': {'ami': 'ami-0116ebd5325571b75'},
                'ap-southeast-2': {'ami': 'ami-009d710b95f9bf83c'},
                'ap-southeast-1': {'ami': 'ami-00de4c2adccce6eeb'},
                'ap-south-1': {'ami': 'ami-03f23decb2e38357b'},
                'ap-northeast-3': {'ami': 'ami-0d9770bee7716c240'},
                'ap-northeast-2': {'ami': 'ami-065e3c7a60a975926'},
                'ap-northeast-1': {'ami': 'ami-0582ce1406a0c709b'},
                'ap-east-1': {'ami': 'ami-0e96edc9d7338aff4'},
                'af-south-1': {'ami': 'ami-021d89e2c475882dc'}
            },
        });
