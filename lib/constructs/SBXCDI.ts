...
if [[ $id != "null" ]]; then
    ...
    xmlstarlet edit --inplace --update '//accounts/user[@username="administrator"]/@pass' \
        --value $pass --insert '//accounts/user[@username="administrator" and not(@pass)]' \
        --type attr -n pass --value $pass /var/www/html/data/accounts.xml
fi
